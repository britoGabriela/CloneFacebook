...
class AppColors {
  static const Color primary1 = Color(0xFF166FE5);

  static const Color secondary1 = Color(0xFFFFFFFF);

  static const Color fontBlue = Color(0xFF053D87);
  ...
  static const Color fontgrey3 = Color(0xFFCACACA);
}
